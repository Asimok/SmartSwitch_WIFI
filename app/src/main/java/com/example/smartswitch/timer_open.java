...
public class timer_open extends AppCompatActivity implements NumberPicker.OnValueChangeListener, View.OnClickListener {
...
//        SS = hexStringToBytes(Second)[0];
    ...
    public void sendOrder() {
        ...
        intent.putExtra("LED_STATE_TIMER_OPEN", LED_STATE_TIMER_OPEN);
        setResult(1, intent);
        Log.d("ee", "open 返回" + Arrays.toString(LED_STATE_TIMER_OPEN));
        timer_open.this.finish();
    }
